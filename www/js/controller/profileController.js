...
angular.module('App').controller('profileController', function ($scope, $cordovaCamera, $location,  Auth) {
    ...
    $scope.imageURI = auth.user.auth.token.image;
